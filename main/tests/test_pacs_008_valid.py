...
# Parametrize test with a specific XML file marked as "valid" and of type "pacs_008"
@pytest.mark.parametrize("pacs_008_iso_xml", [("valid", "pacs_008")], indirect=True)
def test_pacs_008_valid(pacs_008_iso_xml):
    ...
    # Validate creditor XMI (unique identifier)

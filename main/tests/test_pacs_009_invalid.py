...
# Parametrize test with a specific XML file marked as "invalid" and of type "pacs_009"
@pytest.mark.parametrize("pacs_009_iso_xml", [("invalid", "pacs_009")], indirect=True)
def test_pacs_009_invalid(pacs_009_iso_xml):
    ...
    assert msg1["message_type"] == "pacs.009.001.08"
